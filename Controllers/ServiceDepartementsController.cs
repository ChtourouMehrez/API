...
namespace API.Controllers
{
    ...
    [ApiController]
    public class ServiceDepartementsController : ControllerBase
    {
        private readonly IServiceDepartementRepository repository;

        public ServiceDepartementsController(IServiceDepartementRepository repository)
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<ServiceDepartement>> GetById(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<ServiceDepartement>> Create([FromBody] ServiceDepartement obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (org == null)
                    {
                        ...
                        return CreatedAtAction(nameof(GetById), new { id = created.ServiceDepartementId }, created);
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<ServiceDepartement>> Update(int id, ServiceDepartement objet)
        {

            try
            {

                if (id != objet.ServiceDepartementId)
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<ServiceDepartement>> Delete(int id)
        {
            try
            {
        ...
        [HttpGet("{search}")]
        public async Task<ActionResult<IEnumerable<ServiceDepartement>>> Search(string name)
        {
            try
            {
