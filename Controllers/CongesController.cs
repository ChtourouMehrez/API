...
namespace API.Controllers
{
    ...
    {
        private readonly ICongeRepository repository;

        public CongesController(ICongeRepository repository)
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<Conge>> GetById(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<Conge>> Create([FromBody] Conge obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (org == null)
                    {
                        ...
                        return CreatedAtAction(nameof(GetById), new { id = created.CongeId }, created);
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<Conge>> Update(int id, Conge objet)
        {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<Conge>> Delete(int id)
        {
            try
            {
        ...
        [HttpGet("{search}")]
        public async Task<ActionResult<IEnumerable<Conge>>> Search(string name)
        {
            try
            {
